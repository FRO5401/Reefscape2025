...
public class JustCoralRed extends SequentialCommandGroup {
    ...
    public JustCoralRed(CommandSwerveDrivetrain drivetrain, Elevator elevator, Manipulator manipulator) {
        ...
        addCommands(
                ...
                RobotContainer.alignAndDriveToReef(11, Units.inchesToMeters(-2.6), VisionConstants.AUTO_DISTANCE),
                ...
                RobotContainer.alignAndDrive(11, Units.inchesToMeters(-2.6), VisionConstants.REEF_DISTANCE),
