...
public class SideOnePieceBlue extends SequentialCommandGroup {
  ...
  public SideOnePieceBlue(CommandSwerveDrivetrain drivetrain, Elevator elevator, Manipulator manipulator) {
    ...
    addCommands(
      ...
      RobotContainer.alignAndDriveToReef(20,Units.inchesToMeters(-2), VisionConstants.AUTO_DISTANCE),
      ...
      RobotContainer.alignAndDriveToReef(20,Units.inchesToMeters(-2), VisionConstants.REEF_DISTANCE),
