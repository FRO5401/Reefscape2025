...
public class SideOnePieceBlue extends SequentialCommandGroup {
  ...
  public SideOnePieceBlue(CommandSwerveDrivetrain drivetrain, Elevator elevator, Manipulator manipulator) {
    ...
    addCommands(
      ...
      RobotContainer.alignAndDriveToReef(20,Units.inchesToMeters(-2.2), VisionConstants.AUTO_DISTANCE),
      ...
      RobotContainer.alignAndDriveToReef(20,Units.inchesToMeters(-2.2), VisionConstants.REEF_DISTANCE),
      ...
      manipulator.setVelocity(()->1),
      RobotContainer.alignAndDriveToReef(20,Units.inchesToMeters(0), VisionConstants.ALGEA_DISTANCE).until(hasAlgea),
      RobotContainer.alignAndDriveToReef(20,Units.inchesToMeters(2.5), VisionConstants.BARGE_DISTANCE),
