...
public class SideOnePieceRed extends SequentialCommandGroup {
  ...
  public SideOnePieceRed(CommandSwerveDrivetrain drivetrain, Elevator elevator, Manipulator manipulator) {
    ...
    addCommands(
      ...
      RobotContainer.alignAndDriveToReef(11,Units.inchesToMeters(-2.8), VisionConstants.AUTO_DISTANCE),
      ...
      RobotContainer.alignAndDrive(11,Units.inchesToMeters(-2.8), VisionConstants.REEF_DISTANCE),
      ...
      Commands.waitSeconds(1),
      manipulator.setVelocity(()->1),
      RobotContainer.alignAndDrive(11,Units.inchesToMeters(0), VisionConstants.ALGEA_DISTANCE).until(hasAlgea),
      RobotContainer.alignAndDrive(11,Units.inchesToMeters(2.5), VisionConstants.BARGE_DISTANCE),
      RobotContainer.alignAndDrive(5,Units.inchesToMeters(0), VisionConstants.BARGE_DISTANCE),
